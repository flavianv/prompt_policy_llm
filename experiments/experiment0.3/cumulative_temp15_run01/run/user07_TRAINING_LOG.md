...
```json
{
  ...
  "best_correct": 11,
  "worst_correct": 10,
  "mean_normalized_correct": 0.8541666666666667,
  "pass_at_4": false,
  "exact_candidate_count": 0,
  "valid_candidates": 4,
  "candidates": 4,
...
```text
preferred materials for pants in context summer: cotton (per current preference)
preferred fits for shoes: regular, relaxed
default size for shoes: size 38 in EU
preferred brands for shoes: Veja, Dr. Martens
weight: 62 kg
...
```text
preferred materials for pants in context summer: linen, cotton (prior) => wool (temporary until 2026-03-09T09:00:00Z)
preferred fits for shoes: explicitly unknown => regular, relaxed
preferred brands for shoes: Veja, Dr. Martens
weight: 62 kg
```
...
```text
preferred materials for pants in context summer: cotton (permanent)
default size for hats: explicitly unknown
preferred patterns for accessories: no stated preference
purchase intent future-trip (shoes, recipient self) status: active
purchase intent future-trip (shoes, recipient self) deadline: 2026-05-01T18:00:00Z
...
```json
{
  "entries": [
    ...
    {
      "key": "preferred materials for pants in context summer",
      "value": "linen, cotton (prior preference)"
    },
    {
      "key": "default size for hats",
      "value": "explicitly unknown"
