...
```json
{
  ...
  "best_correct": 6,
  "worst_correct": 6,
  "mean_normalized_correct": 0.5454545454545454,
  "pass_at_4": false,
  "exact_candidate_count": 0,
  "valid_candidates": 4,
  "candidates": 4,
...
```text
preferred materials for pants in context summer: wool (2026-03-06T09:00:00Z expiry)
preferred occasions for hats in context sun hat, summer, hiking: casual, formal
preferred cuts for shoes in context walking shoes, travel: low-top
state of purchase intent urgent-gift (shirts, recipient gift): expired; deadline 2026-03-02T18:00:00Z
```
...
```text
preferred materials for pants in context summer: wool (until 2026-03-09T09:00:00Z), then cotton
preferred cuts for shoes in context walking shoes, travel: regular, relaxed
preferred styles for pants: minimal, smart casual
preferred cuts for accessories in context travel bag, travel: compact
preferred patterns for pants in context summer: explicitly unknown
...
```text
preferred materials for pants in context summer: wool (2026-03-06T09:00:00Z temporary)  
preferred materials for pants in context summer: cotton  
...
```json
{
  ...
  "schema_valid": true,
  "exact_state": false,
  "correct_fraction": 0.7894736842105263,
  "history_required_for_reward": false,
  "normalization": "none; fraction is diagnostic only",
  "matching": "unique normalized value intersection; keys ignored",
  "matched_values": [
...
```json
{
  ...
  "best_correct": 15,
  "worst_correct": 15,
  "mean_normalized_correct": 0.7894736842105263,
  "pass_at_4": false,
  "exact_candidate_count": 0,
  "valid_candidates": 4,
  "candidates": 4,
...
Clarks shoes size in EU: 37 (2026-04-28T09:00:00Z)
default size for shoes: size 37 in EU (2026-04-28T09:00:01Z)
state of purchase intent urgent-gift (shirts, recipient gift): active; deadline 2026-05-23T09:00:00Z (2026-04-23T09:00:00Z) → cancelled; deadline 2026-03-02T18:00:00Z (2026-03-31T09:00:00Z) → active; deadline 2026-05-23T09:00:00Z (2026-04-23T09:00:00Z)
```
...
```json
{
  "entries": [
    ...
    {
      "key": "preferred materials for pants in context summer",
      "value": "wool (temporarily until 2026-03-09T09:00:00Z)"
    },
    {
      "key": "default size for hats",
      "value": "explicitly unknown"
...
```json
{
  ...
  "best_correct": 16,
  "worst_correct": 13,
  "mean_normalized_correct": 0.7261904761904762,
  "pass_at_4": false,
  "exact_candidate_count": 0,
  "valid_candidates": 4,
  "candidates": 4,
